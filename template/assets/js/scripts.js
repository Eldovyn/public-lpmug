...
// Basic confirm box upgraded to SweetAlert2 Premium
$('[data-confirm]').each(function() {
  var me = $(this),
      me_data = me.data('confirm');

  me_data = me_data.split("|");
  me.off('click').on('click', function(e) {
    e.preventDefault();
    Swal.fire({
      title: me_data[0],
      text: me_data[1],
      ...
      confirmButtonText: me.data('confirm-text-yes') || 'Yes',
      cancelButtonText: me.data('confirm-text-cancel') || 'Cancel',
      customClass: {
      ...
      } else if (result.isDismissed && me.data('confirm-no')) {
