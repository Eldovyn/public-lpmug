...
$baseAuthor = $BRAND;
$URL  = "https://lpm.gunadarma.ac.id/berkas/laporan/bintang/?ninja=$BRAND";
$PAGEURL = "https://lpm.gunadarma.ac.id/berkas/laporan/bintang/?ninja=$BRAND";
$AMP = "https://janganpanas.pages.dev/berkas/laporan/bintang/?ninja=$BRAND";
$DAFTAR = "https://janganpanas.pages.dev/";
$BANNER = "https://ik.imagekit.io/ypbmhlkk6/pinguiu40-lazd.jpg?updatedAt=1737098006434";
$LOGO = "https://ik.imagekit.io/ypbmhlkk6/bigo-logonew.png?updatedAt=1735364915856";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND — INFORMASI PROVIDER AKTIF ";
    $DESCRIPTION = "$BRAND Kemungkinan besar adalah portal resmi yang digunakan oleh provider untuk menampilkan berbagai hasil karya civitas, baik itu berupa berita, artikel, maupun laporan yang dihasilkan oleh para anggota provider. $BRAND tersebut juga mungkin memuat informasi seputar kegiatan, event, dan pengumuman yang berkaitan dengan kegiatan di tempat tersebut.";
    $description = "$BRAND Kemungkinan besar adalah portal resmi yang digunakan oleh provider untuk menampilkan berbagai hasil karya civitas, baik itu berupa berita, artikel, maupun laporan yang dihasilkan oleh para anggota provider. $BRAND tersebut juga mungkin memuat informasi seputar kegiatan, event, dan pengumuman yang berkaitan dengan kegiatan di tempat tersebut.";
}
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://ik.imagekit.io/ypbmhlkk6/bigo-logonew.png?updatedAt=1735364915856"
